...
CREATE TABLE bln_service_visible
(
    _id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
/**
typename can be "personal","normal"
*/
...
CREATE TABLE bln_service_scopetype
(
    _id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
/*
this table define root circle of serviceteam,
work with child table can find all circles and 
users under serviceteam
*/
CREATE TABLE bln_serviceteam
(
    _id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
    teamname VARCHAR(128) NOT NULL,
    servicecircle_id INTEGER NOT NULL,
...
/*authtype can be: workteam_admin, workteam_member, servedteam_admin,servedteam_member*/
CREATE TABLE bln_authitem_type
(
    _id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,     
    typename VARCHAR(128) NOT NULL   
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

CREATE TABLE bln_application_authitem_child
(
    _id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
/*define operations for each authitem, finally all authitem contain operations*/
CREATE TABLE bln_application_authitem_operation
(
    _id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE bln_service_application_visible
(
    _id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,    
    app_id INTEGER NOT NULL,
    service_scopetype_id INTEGER NOT NULL,
    service_scope_id INTEGER NOT NULL,
    apply_rule VARCHAR(50) DEFAULT 'exclude'  
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


/*relationship between authitems in service*/
CREATE TABLE bln_service_authitem_child
(
    _id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
    service_id INTEGER NOT NULL,
    parent_authitem_id INTEGER NOT NULL,
    child_authitem_id INTEGER NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*
circle can add into service as one role of workingteam, servedteam,friend teams
*/
CREATE TABLE bln_service_application_circle
(
    _id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
    service_id INTEGER NOT NULL,
    app_id INTEGER NOT NULL,
...
/**
parent and child can be within same app or different app, but usually in same service
*/
CREATE TABLE bln_service_application_circle_child
(
    _id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
    parent_id INTEGER NOT NULL,
    child_id   INTEGER NOT NULL
...
CREATE TABLE bln_service_application_circle_user
(
    _id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,   
    user_id INTEGER NOT NULL,
    service_application_circle_id INTEGER NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(
    _id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,   
    authitem_id INTEGER NOT NULL,
    applicationcircle_id INTEGER NOT NULL   
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
/* if endtime is set to date before starttime, means incompleted*/
...
(
    ...
    endtime DATE DEFAULT '1900-01-01',
    profile TEXT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
